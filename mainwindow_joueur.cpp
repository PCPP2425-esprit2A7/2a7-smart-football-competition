...
MainWindowJoueur::MainWindowJoueur(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::MainWindowJoueur)
{
    ui->setupUi(this);
    ...
    connect(arduino, &QSerialPort::readyRead, this, &MainWindowJoueur::readSerial);
    ...
    connect(ui->pdfButton, &QPushButton::clicked, this, &MainWindowJoueur::on_pdfButton_clicked);
...
MainWindowJoueur::~MainWindowJoueur()
{
    delete ui;
}

void MainWindowJoueur::clearForm()
{
    ui->idEdit->clear();
    ui->nameEdit->clear();
...
void MainWindowJoueur::on_cancel_clicked()
{
...
bool MainWindowJoueur::validateInput()
{
...
void MainWindowJoueur::on_add_clicked()
{
...
void MainWindowJoueur::on_supprimer_clicked()
{
...
void MainWindowJoueur::on_modify_clicked()
{
    if (!validateInput()) return;  // Vérifie si les entrées sont valides
...
void MainWindowJoueur::afficher()
{
...
void MainWindowJoueur::on_tableView_clicked(const QModelIndex &index)
{
...
/*void MainWindowJoueur::on_pdfButton_clicked()
{
...
void MainWindowJoueur::onSearch()
{
...
void MainWindowJoueur::on_tri_changed(int index)
{
...
void MainWindowJoueur::on_stat_clicked()
{
    dialog_window = new DialogJoueur(this);
    dialog_window->setAttribute(Qt::WA_DeleteOnClose); // Ensure memory cleanup
    dialog_window->show();

}

void MainWindowJoueur::RechercheVocale() {
...
QString MainWindowJoueur::demarrerReconnaissanceVocale() {
    QProcess process;
...
void MainWindowJoueur::rechercherJoueurParNom(const QString &name) {
    QSqlQueryModel *model = new QSqlQueryModel();
    QSqlQuery query;
...
void MainWindowJoueur::onTeam1ButtonPressed()
{
...
void MainWindowJoueur::onTeam2ButtonPressed()
{
...
void MainWindowJoueur::readSerial()
{
...
void MainWindowJoueur::update_label() {
...
void MainWindowJoueur::on_dark_clicked()
{
...
void MainWindowJoueur::on_light_clicked()
{
...
void MainWindowJoueur::on_btn_supp_clicked()
{
...
void MainWindowJoueur::on_btn_arb_clicked()
{
    this->close(); // Cache la fenêtre actuelle (facultatif)
...
void MainWindowJoueur::on_btn_tickets_clicked()
{
    this->close(); // Cache la fenêtre actuelle (facultatif)
...
void MainWindowJoueur::on_btn_match_clicked()
{
    this->close(); // Cache la fenêtre actuelle (facultatif)
...
void MainWindowJoueur::on_home_clicked()
{
    this->close(); // Cache la fenêtre actuelle (facultatif)
...
void MainWindowJoueur::on_btn_team_clicked()
{
    this->close(); // Cache la fenêtre actuelle (facultatif)
