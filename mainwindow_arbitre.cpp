...
MainWindowArbitre::MainWindowArbitre(QWidget *parent)
    : QMainWindow(parent), ui(new Ui::MainWindowArbitre)
{
    ui->setupUi(this);
    ...
    connect(ui->pushButton_modifier, &QPushButton::clicked, this, &MainWindowArbitre::on_pushButton_modifier_clicked);
    connect(ui->tableView, &QTableView::clicked, this, &MainWindowArbitre::selectionnerArbitre);
    connect(ui->pushButton_cancel, &QPushButton::clicked, this, &MainWindowArbitre::on_pushButton_cancel_clicked);
    connect(ui->lineEdit_rechercher, &QLineEdit::textChanged, this, &MainWindowArbitre::on_lineEdit_rechercher_textChanged);
    connect(ui->dark, &QPushButton::clicked, this, &MainWindowArbitre::on_dark_clicked);
    connect(ui->light, &QPushButton::clicked, this, &MainWindowArbitre::on_light_clicked);

    connect(ui->comboBox_tri, &QComboBox::currentTextChanged, this, &MainWindowArbitre::trierArbitres);
    connect(ui->PDF, &QPushButton::clicked, this, &MainWindowArbitre::on_PDF_clicked);
    connect(ui->btn_ouvrirEmailDialog, &QPushButton::clicked, this, &MainWindowArbitre::on_btn_ouvrirEmailDialog_clicked);
    connect(ui->pushButton_guess, &QPushButton::clicked, this, &MainWindowArbitre::on_pushButton_guess_clicked);
    connect(ui->pushButton_Historique, &QPushButton::clicked, this, &MainWindowArbitre::on_pushButton_Historique_clicked);
    connect(ui->btn_test_voice, &QPushButton::clicked, this, &MainWindowArbitre::on_btn_test_voice_clicked);
    // Inside your MainWindow constructor or setup function
    //connect(ui->btn_test_voice, &QPushButton::clicked, this, &MainWindowArbitre::onTestVoiceClicked);
...
MainWindowArbitre::~MainWindowArbitre()
{
    delete ui;
}

void MainWindowArbitre::on_pushButton_cancel_clicked()
{
...
void MainWindowArbitre::on_pushButton_ajouter_clicked() {
...
void MainWindowArbitre::afficher()
{
...
void MainWindowArbitre::on_pushButton_modifier_clicked() {
...
void MainWindowArbitre::selectionnerArbitre() {
...
void MainWindowArbitre::on_pushButton_supprimer_clicked() {
...
void MainWindowArbitre::on_lineEdit_rechercher_textChanged(const QString &arg1) {
    arbitre a(0, "", "", 0, 0, "", "");
...
void MainWindowArbitre::on_dark_clicked()
{
...
void MainWindowArbitre::on_light_clicked()
{
    ...
    ui->bg->setStyleSheet("#bg{background-image: url(:/img/img/bg.jpg);}");
    ui->home->setStyleSheet("#home{border-radius: 10px;padding: 5px;background: #218555; }");
}


void MainWindowArbitre::filtrerParCategorie(const QString &category)
{
...
void MainWindowArbitre::trierArbitres(const QString &colonne)
{
...
/*void MainWindowArbitre::on_pushButton_statistiques_clicked()
{
    Statistique stats;
    stats.exec();
...
void MainWindowArbitre::on_pushButton_statistiques_clicked()
{
    dialog_window = new DialogArbitre(this);
    dialog_window->setAttribute(Qt::WA_DeleteOnClose); // Ensure memory cleanup
    dialog_window->show();
}
...
/*void MainWindowArbitre::exporterListeArbitresPDF()
{
...
void MainWindowArbitre::on_btn_ouvrirEmailDialog_clicked()
{
    EmailDialog dialog(this);
    dialog.exec(); // Affiche la fenêtre modale
    logAction("email envoyer a un arbitre");
}
void MainWindowArbitre::on_pushButton_guess_clicked()
{
...
void MainWindowArbitre::envoyerEmail(const QString &email, const QString &nom)
{
...
void MainWindowArbitre::logAction(const QString &actionDetails)
{
    ...
    // Dans MainWindowArbitre.cpp
void MainWindowArbitre::on_pushButton_Historique_clicked()
{
    HistoriqueDialog h(this);
    h.exec();
}
void MainWindowArbitre::on_btn_test_voice_clicked()
{
...
void MainWindowArbitre::testerCommandeVocale(QString spokenText)
{
    QString pythonExe = "C:/Users/Hammami Yessmie/AppData/Local/Programs/Python/Python313/python.exe";
    QString scriptPath = "C:/Users/Hammami Yessmie/OneDrive/Desktop/Atelier_Connexion (2)/Atelier_Connexion/voice_command_system/understand_command.py";
...
bool MainWindowArbitre::chercherEtAfficher(const QString &nomRecherche)
{
...
void MainWindowArbitre::on_PDF_clicked()
{
    ...
    void MainWindowArbitre::on_bouton_billet_arbitre_clicked()
    {
    ...
    void MainWindowArbitre::on_bouton_supporteur_arbitre_clicked()
    {
        this->close(); // Cache la fenêtre actuelle (facultatif)
    ...
    void MainWindowArbitre::on_bouton_joueur_arbitre_clicked()
    {
        this->close(); // Cache la fenêtre actuelle (facultatif)
        MainWindowJoueur *w5 = new MainWindowJoueur(); // Crée une nouvelle fenêtre
        w5->setAttribute(Qt::WA_DeleteOnClose); // Pour éviter les fuites mémoire
        w5->show(); // Affiche la nouvelle fenêtre
    }


    void MainWindowArbitre::on_bouton_match_arbitre_clicked()
    {
        this->close(); // Cache la fenêtre actuelle (facultatif)
        MainWindowMatch *w6 = new MainWindowMatch(); // Crée une nouvelle fenêtre
        w6->setAttribute(Qt::WA_DeleteOnClose); // Pour éviter les fuites mémoire
        w6->show(); // Affiche la nouvelle fenêtre
    }


    void MainWindowArbitre::on_home_clicked()
    {
        this->close(); // Cache la fenêtre actuelle (facultatif)
    ...
    void MainWindowArbitre::on_bouton_equipe_arbitre_clicked()
    {
        this->close(); // Cache la fenêtre actuelle (facultatif)
