...
QT_BEGIN_NAMESPACE
namespace Ui {class MainWindowJoueur; }
class PlayerSubstitutionDialog;
class arduino;
QT_END_NAMESPACE

class MainWindowJoueur : public QMainWindow
{
    Q_OBJECT

public:
    explicit MainWindowJoueur(QWidget *parent = nullptr);
    ~MainWindowJoueur();
