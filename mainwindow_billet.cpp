    ...
    , ui(new Ui::MainWindowBillet)
{
    ...
    if (serial->open(QIODevice::ReadOnly)) {
        connect(serial, &QSerialPort::readyRead, this, &MainWindowBillet::readSerial);
...
MainWindowBillet::~MainWindowBillet()
{
    serial->close();
    delete ui;
}
...
*/
void MainWindowBillet::afficher()
{
    QSqlQueryModel *model = new QSqlQueryModel();
...
void MainWindowBillet::on_add_clicked()
{
...
void MainWindowBillet::on_delete_2_clicked()
{
...
void MainWindowBillet::on_cancel_clicked()
{
...
void MainWindowBillet::on_table_clicked(const QModelIndex &index)
{
...
void MainWindowBillet::on_tri_activated(int index)
{
...
void MainWindowBillet::on_pdf_clicked() {
...
void MainWindowBillet::on_light_clicked()
{
...
//     }
// }
void MainWindowBillet::readSerial()
{
...
void MainWindowBillet::verifierUID(const QString& uid)
{
    QSqlQuery query;
