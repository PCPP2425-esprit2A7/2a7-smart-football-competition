...
public:
    ...
    void setupUi(QMainWindow *MainWindowArbitre)
    {
        if (MainWindowArbitre->objectName().isEmpty())
            MainWindowArbitre->setObjectName("MainWindowArbitre");
        MainWindowArbitre->resize(1537, 710);
        centralwidget = new QWidget(MainWindowArbitre);
...
""));
        ...
        comboBox_tri->setGeometry(QRect(1230, 80, 151, 31));
...
"}"));
        ...
        pushButton_modifier->setGeometry(QRect(1370, 520, 93, 29));
...
"}"));
        ...
        pushButton_supprimer->setGeometry(QRect(1260, 520, 93, 29));
...
"}"));
        ...
        tableView->setGeometry(QRect(560, 120, 901, 381));
...
"}"));
        ...
        pushButton_statistiques->setGeometry(QRect(1370, 10, 111, 31));
        QFont font2;
...
"}"));
        ...
        PDF->setGeometry(QRect(1400, 80, 51, 31));
        QFont font3;
...
"}"));
        ...
        btn_ouvrirEmailDialog->setGeometry(QRect(1200, 10, 51, 31));
...
"}"));
        ...
        pushButton_guess->setGeometry(QRect(990, 520, 93, 29));
...
"}"));
        ...
        label_resultat->setGeometry(QRect(560, 520, 431, 81));
...
""));
        ...
        pushButton_Historique->setGeometry(QRect(1260, 10, 91, 31));
...
"}"));
        ...
        dark->setGeometry(QRect(130, 570, 93, 29));
        dark->setFont(font4);
...
"}"));
        ...
        bouton_match_arbitre->setGeometry(QRect(40, 420, 71, 61));
...
""));
        ...
        bouton_billet_arbitre->setGeometry(QRect(30, 490, 91, 61));
...
""));
        ...
        bouton_equipe_arbitre->setGeometry(QRect(30, 340, 93, 71));
...
""));
        ...
        bg->setObjectName("bg");
        bg->setGeometry(QRect(-10, 0, 1521, 721));
...
" border-radius: 10px;         /* Rounded corners */\n"
"    padding: 5px;}"));
        bg_2 = new QLabel(centralwidget);
        bg_2->setObjectName("bg_2");
        bg_2->setGeometry(QRect(10, 10, 141, 91));
        bg_2->setStyleSheet(QString::fromUtf8("#bg_2 {\n"
"    border: none;\n"
"    qproperty-icon:url(:/img/img/logo_yedkom-removebg.png);\n"
"    qproperty-iconSize: 64px 64px; /* Ajuste la taille selon ton bouton */\n"
"}"));
        bg_2->setPixmap(QPixmap(QString::fromUtf8(":/img/img/logo_yedkom-removebg.png")));
        bg_2->setScaledContents(true);
        home = new QPushButton(centralwidget);
        home->setObjectName("home");
        home->setGeometry(QRect(1400, 620, 93, 29));
        QFont font5;
...
"    background: #218555\n"
"}"));
        MainWindowArbitre->setCentralWidget(centralwidget);
        bg->raise();
        form->raise();
        menu->raise();
        label->raise();
        ...
        bg_2->raise();
        home->raise();
        menubar = new QMenuBar(MainWindowArbitre);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 1537, 26));
        MainWindowArbitre->setMenuBar(menubar);
        statusbar = new QStatusBar(MainWindowArbitre);
        statusbar->setObjectName("statusbar");
        MainWindowArbitre->setStatusBar(statusbar);

        retranslateUi(MainWindowArbitre);

        QMetaObject::connectSlotsByName(MainWindowArbitre);
    } // setupUi

    void retranslateUi(QMainWindow *MainWindowArbitre)
    {
        MainWindowArbitre->setWindowTitle(QCoreApplication::translate("MainWindowArbitre", "MainWindow", nullptr));
        menu->setText(QString());
        label->setText(QCoreApplication::translate("MainWindowArbitre", "Id", nullptr));
        label_2->setText(QCoreApplication::translate("MainWindowArbitre", "Name", nullptr));
        label_3->setText(QCoreApplication::translate("MainWindowArbitre", "last_name", nullptr));
        label_4->setText(QCoreApplication::translate("MainWindowArbitre", "Email", nullptr));
        label_5->setText(QCoreApplication::translate("MainWindowArbitre", "Nb_carton", nullptr));
        label_6->setText(QCoreApplication::translate("MainWindowArbitre", "Nb_match_a", nullptr));
        label_7->setText(QCoreApplication::translate("MainWindowArbitre", "Category", nullptr));
        comboBox->setItemText(0, QCoreApplication::translate("MainWindowArbitre", "a.touch", nullptr));
        comboBox->setItemText(1, QCoreApplication::translate("MainWindowArbitre", "a.principale", nullptr));
        comboBox->setItemText(2, QCoreApplication::translate("MainWindowArbitre", "a.changement", nullptr));
        comboBox->setItemText(3, QCoreApplication::translate("MainWindowArbitre", "a.var", nullptr));

        lineEdit_rechercher->setPlaceholderText(QCoreApplication::translate("MainWindowArbitre", "Recherche par nom", nullptr));
        comboBox_tri->setItemText(0, QCoreApplication::translate("MainWindowArbitre", "a.principale", nullptr));
        comboBox_tri->setItemText(1, QCoreApplication::translate("MainWindowArbitre", "a.changement", nullptr));
        comboBox_tri->setItemText(2, QCoreApplication::translate("MainWindowArbitre", "a.var", nullptr));
        comboBox_tri->setItemText(3, QCoreApplication::translate("MainWindowArbitre", "a.touch", nullptr));

        comboBox_tri->setPlaceholderText(QCoreApplication::translate("MainWindowArbitre", "Filtrer", nullptr));
        pushButton_ajouter->setText(QCoreApplication::translate("MainWindowArbitre", "Add", nullptr));
        pushButton_cancel->setText(QCoreApplication::translate("MainWindowArbitre", "Cancel", nullptr));
        pushButton_modifier->setText(QCoreApplication::translate("MainWindowArbitre", "Modify", nullptr));
        pushButton_supprimer->setText(QCoreApplication::translate("MainWindowArbitre", "Delete", nullptr));
        pushButton_statistiques->setText(QCoreApplication::translate("MainWindowArbitre", "Report statics", nullptr));
        PDF->setText(QString());
        btn_ouvrirEmailDialog->setText(QString());
        pushButton_guess->setText(QString());
        label_resultat->setText(QString());
        pushButton_Historique->setText(QCoreApplication::translate("MainWindowArbitre", "Historique", nullptr));
        btn_test_voice->setText(QString());
        light->setText(QCoreApplication::translate("MainWindowArbitre", "Light", nullptr));
        dark->setText(QCoreApplication::translate("MainWindowArbitre", "Dark", nullptr));
        ...
        home->setText(QCoreApplication::translate("MainWindowArbitre", "Home", nullptr));
    } // retranslateUi

};

namespace Ui {
    class MainWindowArbitre: public Ui_MainWindowArbitre {};
} // namespace Ui
