/****************************************************************************
** Meta object code from reading C++ file 'dialog_billet.h'
**
...
#error "The header file 'dialog_billet.h' doesn't include <QObject>."
...
constexpr auto qt_meta_stringdata_CLASSgenerate_ticketsENDCLASS = QtMocHelpers::stringData(
    ...
    "on_table_m_clicked",
    "on_table_b_clicked",
    "on_generate_qr_clicked",
    "on_delete_qr_clicked",
    "on_save_clicked",
    "on_delete_ticket_clicked"
);
...
Q_CONSTINIT const QMetaObject generate_tickets::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSgenerate_ticketsENDCLASS_t,
        ...
        // method 'on_table_s_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QModelIndex &, std::false_type>,
        // method 'on_table_m_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QModelIndex &, std::false_type>,
        // method 'on_table_b_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QModelIndex &, std::false_type>,
        // method 'on_generate_qr_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_delete_qr_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_save_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_delete_ticket_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void generate_tickets::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<generate_tickets *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->on_table_s_clicked((*reinterpret_cast< std::add_pointer_t<QModelIndex>>(_a[1]))); break;
        case 1: _t->on_table_m_clicked((*reinterpret_cast< std::add_pointer_t<QModelIndex>>(_a[1]))); break;
        case 2: _t->on_table_b_clicked((*reinterpret_cast< std::add_pointer_t<QModelIndex>>(_a[1]))); break;
        case 3: _t->on_generate_qr_clicked(); break;
        case 4: _t->on_delete_qr_clicked(); break;
        case 5: _t->on_save_clicked(); break;
        case 6: _t->on_delete_ticket_clicked(); break;
        default: ;
        }
    }
}
