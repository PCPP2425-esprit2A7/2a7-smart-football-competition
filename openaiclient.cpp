...
OpenAIClient::OpenAIClient(QObject *parent) : QObject(parent) {
    ...
    apiKey = "TA_CLE_API";  // Remplace par ta clé OpenAI
...
void OpenAIClient::envoyerRequete(const QString &question) {
    ...
    QJsonArray messages;
    messages.append(QJsonObject{{"role", "system"}, {"content", "Tu es un assistant répondant aux questions sur les services."}});
